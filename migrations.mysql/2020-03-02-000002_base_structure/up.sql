...
CREATE TABLE IF NOT EXISTS `access_option` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `entity_admin` (
...
CREATE TABLE IF NOT EXISTS `public_key_dest_rule` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `public_key_signature` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
    `public_key_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `server_ldap_access_option` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
    `server_id` int(10) unsigned NOT NULL,
    `option` enum('command', 'from', 'no-agent-forwarding', 'no-port-forwarding', 'no-pty', 'no-X11-forwarding') NOT NULL,
    `value` text,
...
IF NOT EXISTS (
    ...
    WHERE
        ...
        CONSTRAINT_NAME   = 'FK_access_entity' AND
